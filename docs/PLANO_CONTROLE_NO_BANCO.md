...
| `cancelamentos.json`, `exclusoes.json` | remessa/cancelamento | contratos entre projetos (process-automation escreve, ERP lê) | ERP | 7 / 8 | **Fase 3, 22/09/2026 18:31**: `financeiro.remessa_cancelamento_apontado` / `remessa_exclusao_apontada` |
